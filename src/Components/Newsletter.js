      ...
      <div className="mx-auto px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          ...
          <div className="max-w-xl lg:max-w-lg">
            {/* Section label */}
            <h3 className="text-base font-semibold text-indigo-400 uppercase tracking-wide">Stay Updated</h3>
            ...
            <p className="mt-4 text-lg text-gray-300">
              Get the latest articles, tips, and resources straight to your inbox. No spam, just valuable insights weekly.
            </p>
